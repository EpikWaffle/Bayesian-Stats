...
```
Benedict's prior is worse than Alex's because his predictive prior check has a really small number and a really big number, whereas Alex's produces two numbers close to 0.50, neither small nor big.
...
Because Alex's odds are over 1 then Alex's analysis implies that there are a large number of teenagers who have televisions in their room. Benedict's analysis would imply that there are more teenagers without televisions in their room than there are with. 
...
```
As sample size increased, the posterior interval got closer and closer to the exact estimate.
